        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6 py-20">
          ...
          >
            ...
            <div className="mt-10 flex flex-wrap justify-center gap-5 lg:justify-start">
              ...
              <Button asChild variant="outline" size="xl" className="h-14 px-10 text-base border-white/40 bg-white/5 text-white hover:bg-white/10 backdrop-blur-sm shadow-lux">
